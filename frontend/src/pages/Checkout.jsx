...
function Checkout() {
    ...
    const handlePlaceOrder = async () => {
        ...
        try {
            ...
            setErrorMessage(error.response?.data?.message || JSON.stringify(error.response?.data) || 'Order failed');
        } finally {
            setLoading(false);
        }
    };
        ...
        return (
            <div className="min-h-screen bg-white flex items-center justify-center px-4">
                <div className="text-center">
                    ...
                    <p className="text-gray-500 mb-6">Redirecting to your orders...</p>
                </div>
            </div>
        );
    }
                                    ...
                                    {[
                                        ...
                                        <button
                                            ...
                                            className={`p-4 rounded-xl border-2 ${
                                                formData.paymentMethod === option.id ? 'border-black' : 'border-gray-200'
                                            }`}>
