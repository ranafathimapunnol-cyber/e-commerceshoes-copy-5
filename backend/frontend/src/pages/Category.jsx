...
function Categories() {
    ...
    const categories = [
        ...
        { id: 'WOMENS', name: 'WOMEN', image: '/categories/women.jpg' },
        { id: 'KIDS', name: 'KIDS', image: '/categories/kids.jpg' },
        { id: 'ACCESSORIES', name: 'ACCESSORIES', image: '/categories/accessories.jpg' },
    ];
    ...
    return (
        <div className="bg-white min-h-screen pt-28 pb-16 px-4 md:px-8">
            <div className="max-w-7xl mx-auto">
                ...
                {/* Filter and Sort Bar - Same as Products page */}
                <div className="mb-8">
