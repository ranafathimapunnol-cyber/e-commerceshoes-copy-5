...
function ShopByCategory() {
    ...
    const apiCategory = categoryMap[category?.toLowerCase()] || category?.toUpperCase();

    useEffect(() => {
        const fetchProducts = async () => {
            setLoading(true);
            try {
                const res = await axios.get(`http://127.0.0.1:8000/api/products/?category=${apiCategory}`);
    ...
    const getCategoryDisplayName = () => {
        ...
        return names[category?.toLowerCase()] || `${category}'s Collection`;
    };
    ...
    const getCategoryBadge = () => {
        ...
        return badges[category?.toLowerCase()] || 'Premium Collection';
    };
        ...
        return (
            <div className="min-h-screen bg-white pt-28 flex justify-center items-center">
                <div className="text-center">
                    ...
                    <p className="text-gray-500">Loading {getCategoryDisplayName()}...</p>
                </div>
            </div>
        );
    }
        ...
        return (
            <div className="min-h-screen bg-white pt-28 pb-20 px-4 md:px-8">
                <div className="max-w-7xl mx-auto text-center">
                    ...
                    <p className="text-gray-400 mb-6">{getCategoryDisplayName()} is currently empty. Check back soon!</p>
                    <button
            ...
            <div className="max-w-7xl mx-auto">
                <div className="text-center mb-10">
                    ...
                    <p className="text-gray-400 max-w-md mx-auto">
                        Discover premium {category?.toLowerCase()} collection crafted with exceptional quality.
                    </p>
